...
public class Employee {
    ...
    @OneToMany(mappedBy = "employeeByCordinatorId")
    @JsonIgnore
    private Collection<Course> coursesById;;
    @OneToMany(mappedBy = "employeeByDeputycordinatorId")
    @JsonIgnore
    private Collection<Course> coursesById_0;
    @JsonIgnore
    @OneToMany(mappedBy = "employee")
    private Collection<Batch> batches;
    @JsonIgnore
    @OneToMany(mappedBy = "teacher")
    private Collection<Clazz> teachers;
    @JsonIgnore
    @OneToMany(mappedBy = "employee")
